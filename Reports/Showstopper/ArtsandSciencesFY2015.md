...
351 Alumni from the School of Arts and Sciences gave in the 2015 Fiscal Year. This accounts for 18% of donor participation.




![](C:\Users\jr2ef\ONEDRI~1\PRESEN~1\DRIVE2~1\DRIVE2~1\Reports\SHOWST~1\ARTSAN~1/figure-html/basicPlots-1.png)<!-- -->
...
#nnybqlcadi .gt_sep_right {
  border-right: 5px solid #FFFFFF;
}

#nnybqlcadi .gt_group_heading {
  padding: 8px;
  /* row_group.padding */
  color: #333333;
  background-color: #FFFFFF;
...
#nnybqlcadi .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  /* row_group.background.color */
...
#nnybqlcadi .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
  /* row.striping.background_color */
}

#nnybqlcadi .gt_from_md > :first-child {
  margin-top: 0;
}

#nnybqlcadi .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#nnybqlcadi .gt_first_summary_row {
  padding-top: 8px;
  /* summary_row.padding */
  padding-bottom: 8px;
  /* summary_row.padding */
...
#nnybqlcadi .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
...
#nnybqlcadi .gt_first_grand_summary_row {
  padding-top: 8px;
  /* grand_summary_row.padding */
  padding-bottom: 8px;
  /* grand_summary_row.padding */
...
#nnybqlcadi .gt_font_normal {
  font-weight: normal;
}

#nnybqlcadi .gt_font_bold {
  font-weight: bold;
}

#nnybqlcadi .gt_font_italic {
  font-style: italic;
}
...
#nnybqlcadi .gt_footnote_marks {
  font-style: italic;
  font-size: 65%;
}
</style>
<div id="nnybqlcadi" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;"><table class="gt_table">
...
**Los Angeles-Long Beach-Glendale, CA** was the MSA with the most number of Arts and Sciences alumni donors (4).

<img src="C:/Users/jr2ef/OneDrive - University of Virginia/Presentations/Drive 2020 - Ready Set Bake - RMarkdown for Reproducibility/Drive2019-repo/Reports/Showstopper/ArtsandSciencesFY2015_files/figure-html/geoHist-1.png" width="1344" />
