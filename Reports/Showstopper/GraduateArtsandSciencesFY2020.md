...
190 Alumni from the School of Graduate Arts and Sciences gave in the 2020 Fiscal Year. This accounts for 10% of donor participation.




![](C:\Users\jr2ef\OneDrive - University of Virginia\Presentations\Drive 2020 - Ready Set Bake - RMarkdown for Reproducibility\Drive2019-repo\Reports\Showstopper\GraduateArtsandSciencesFY2020_files/figure-html/basicPlots-1.png)<!-- -->
...
#wyqaopjtuo .gt_sep_right {
  border-right: 5px solid #FFFFFF;
}

#wyqaopjtuo .gt_group_heading {
  padding: 8px;
  /* row_group.padding */
  color: #333333;
  background-color: #FFFFFF;
...
#wyqaopjtuo .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  /* row_group.background.color */
...
#wyqaopjtuo .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
  /* row.striping.background_color */
}

#wyqaopjtuo .gt_from_md > :first-child {
  margin-top: 0;
}

#wyqaopjtuo .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#wyqaopjtuo .gt_first_summary_row {
  padding-top: 8px;
  /* summary_row.padding */
  padding-bottom: 8px;
  /* summary_row.padding */
...
#wyqaopjtuo .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
...
#wyqaopjtuo .gt_first_grand_summary_row {
  padding-top: 8px;
  /* grand_summary_row.padding */
  padding-bottom: 8px;
  /* grand_summary_row.padding */
...
#wyqaopjtuo .gt_font_normal {
  font-weight: normal;
}

#wyqaopjtuo .gt_font_bold {
  font-weight: bold;
}

#wyqaopjtuo .gt_font_italic {
  font-style: italic;
}
...
#wyqaopjtuo .gt_footnote_marks {
  font-style: italic;
  font-size: 65%;
}
</style>
<div id="wyqaopjtuo" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;"><table class="gt_table">
...
**Chicago-Naperville-Evanston, IL** was the MSA with the most number of Graduate Arts and Sciences alumni donors (4).

<img src="C:/Users/jr2ef/OneDrive - University of Virginia/Presentations/Drive 2020 - Ready Set Bake - RMarkdown for Reproducibility/Drive2019-repo/Reports/Showstopper/GraduateArtsandSciencesFY2020_files/figure-html/geoHist-1.png" width="1344" />
