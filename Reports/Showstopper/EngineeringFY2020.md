...
![](C:\Users\jr2ef\OneDrive - University of Virginia\Presentations\Drive 2020 - Ready Set Bake - RMarkdown for Reproducibility\Drive2019-repo\Reports\Showstopper\EngineeringFY2020_files/figure-html/basicPlots-1.png)<!-- -->
...
#yqjicikbwp .gt_sep_right {
  border-right: 5px solid #FFFFFF;
}

#yqjicikbwp .gt_group_heading {
  padding: 8px;
  /* row_group.padding */
  color: #333333;
  background-color: #FFFFFF;
...
#yqjicikbwp .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  /* row_group.background.color */
...
#yqjicikbwp .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
  /* row.striping.background_color */
}

#yqjicikbwp .gt_from_md > :first-child {
  margin-top: 0;
}

#yqjicikbwp .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#yqjicikbwp .gt_first_summary_row {
  padding-top: 8px;
  /* summary_row.padding */
  padding-bottom: 8px;
  /* summary_row.padding */
...
#yqjicikbwp .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
...
#yqjicikbwp .gt_first_grand_summary_row {
  padding-top: 8px;
  /* grand_summary_row.padding */
  padding-bottom: 8px;
  /* grand_summary_row.padding */
...
#yqjicikbwp .gt_font_normal {
  font-weight: normal;
}

#yqjicikbwp .gt_font_bold {
  font-weight: bold;
}

#yqjicikbwp .gt_font_italic {
  font-style: italic;
}
...
#yqjicikbwp .gt_footnote_marks {
  font-style: italic;
  font-size: 65%;
}
</style>
<div id="yqjicikbwp" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;"><table class="gt_table">
  ...
  <tbody class="gt_table_body">
    ...
    <tr>
      <td class="gt_row gt_left">Warren-Troy-Farmington Hills, MI</td>
      <td class="gt_row gt_right">0</td>
      <td class="gt_row gt_right">2</td>
      <td class="gt_row gt_right">0&percnt;</td>
    </tr>
...
**Montgomery County-Bucks County-Chester County, PA** was the MSA with the most number of Engineering alumni donors (1).

<img src="C:/Users/jr2ef/OneDrive - University of Virginia/Presentations/Drive 2020 - Ready Set Bake - RMarkdown for Reproducibility/Drive2019-repo/Reports/Showstopper/EngineeringFY2020_files/figure-html/geoHist-1.png" width="1344" />
