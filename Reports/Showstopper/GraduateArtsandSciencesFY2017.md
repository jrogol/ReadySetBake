...
212 Alumni from the School of Graduate Arts and Sciences gave in the 2017 Fiscal Year. This accounts for 8% of donor participation.




![](C:\Users\jr2ef\OneDrive - University of Virginia\Presentations\Drive 2020 - Ready Set Bake - RMarkdown for Reproducibility\Drive2019-repo\Reports\Showstopper\GraduateArtsandSciencesFY2017_files/figure-html/basicPlots-1.png)<!-- -->
...
#ofqwwyhhrx .gt_sep_right {
  border-right: 5px solid #FFFFFF;
}

#ofqwwyhhrx .gt_group_heading {
  padding: 8px;
  /* row_group.padding */
  color: #333333;
  background-color: #FFFFFF;
...
#ofqwwyhhrx .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  /* row_group.background.color */
...
#ofqwwyhhrx .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
  /* row.striping.background_color */
}

#ofqwwyhhrx .gt_from_md > :first-child {
  margin-top: 0;
}

#ofqwwyhhrx .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#ofqwwyhhrx .gt_first_summary_row {
  padding-top: 8px;
  /* summary_row.padding */
  padding-bottom: 8px;
  /* summary_row.padding */
...
#ofqwwyhhrx .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
...
#ofqwwyhhrx .gt_first_grand_summary_row {
  padding-top: 8px;
  /* grand_summary_row.padding */
  padding-bottom: 8px;
  /* grand_summary_row.padding */
...
#ofqwwyhhrx .gt_font_normal {
  font-weight: normal;
}

#ofqwwyhhrx .gt_font_bold {
  font-weight: bold;
}

#ofqwwyhhrx .gt_font_italic {
  font-style: italic;
}
...
#ofqwwyhhrx .gt_footnote_marks {
  font-style: italic;
  font-size: 65%;
}
</style>
<div id="ofqwwyhhrx" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;"><table class="gt_table">
...
**Washington-Arlington-Alexandria, DC-VA-MD-WV** was the MSA with the most number of Graduate Arts and Sciences alumni donors (3).

<img src="C:/Users/jr2ef/OneDrive - University of Virginia/Presentations/Drive 2020 - Ready Set Bake - RMarkdown for Reproducibility/Drive2019-repo/Reports/Showstopper/GraduateArtsandSciencesFY2017_files/figure-html/geoHist-1.png" width="1344" />
