...
-- This SQL query creates a crosswalk between Zip codes and county-level FIPS codes.
-- This data links to Core-Based Statistical Areas (CBSA),
-- Metropolitan Statistical Areas (MSA) and combined Statistical Areas (CSAs).
